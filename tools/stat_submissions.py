...
def stat_categories(path):
    ...
    for category in categories:
        for dirpath, dirnames, filenames in os.walk(categories[category]["path"], topdown=True):
            if (category == "presentation" or category == "demo" or category == "paper-book-presentation" or category == "smart-contract-protocol"):
...
def print_help_info():
    print('')
    print('DD2585 Student Submissions Statistic Tool')
